	...
	<div class="col s12 ">
		<div class="card">
			<div class="card-content margin" style="margin: 12px;">
				<div class="row">
					<div class="col s6 m6 l6">
						<h4 class="cardbox-text light left margin">Daftar Sub Kegiatan Bidang Kebijakan Transportasi Perkotaan</h4>
					</div>
					<!--                    <div class="col s6 m6 l6">-->
			...
			<div class="valign-wrapper">
				<a href="<?= base_url('kegiatan-ptpp') ?>" class="valign-wrapper" style="margin-left: 20px;font-size: 15pt;"><i class="mdi-hardware-keyboard-arrow-left black-text" style="font-size: 25pt !important;"></i> Kembali</a>
			</div>
			<br>
						...
						<td>
							<div class="row">
								...
								<a href="#modal-hapus"
									...
									title="hapus data" data-id="<?= $value->id ?>" data-bidang="KTP" data-idk="<?= $value->id_kegiatan ?>">
