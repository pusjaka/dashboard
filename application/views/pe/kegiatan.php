			...
			<table class="bordered" id="barang-table">
                ...
                ?>
					<tr>
						...
						<td class="grey-text text-darken-1" width="20%"><?= $value->keterangan ?></td>
...
<div id="modal-tambah" class="modal">
	...
	<div class="modal-content center">
		...
		<div class="row">
            ...
            <div class="input-field col s12 m6">
				<p style="font-size: 9pt;">Tanggal Selesai Kegiatan</p>
				<input type="date" name="tanggal_kegiatan_end" required>
			</div>
            
			<div class="input-field col s12 m6">
				<label for="keterangan">Update Terakhir</label>
				<textarea name="keterangan" placeholder="Masukkan Update" id="" cols="30" rows="10"></textarea>
			</div>
		</div>
	</div>
...
<div id="modal-edit" class="modal">
	...
	<div class="modal-content center">
		...
		<div class="row">
			<div class="input-field col s12 m6">
				<label for="nama_kegiatan">Nama Kegiatan</label>
				<input type="text" placeholder="Masukkan Nama Kegiatan" class="kegiatan" name="nama_kegiatan">
			</div>
